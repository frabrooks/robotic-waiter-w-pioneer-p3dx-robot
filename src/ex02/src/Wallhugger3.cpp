...
void Wallhugger3::Init(){
    vel_pub = node.advertise<geometry_msgs::Twist>("cmd_vel",100);
    
    laser_sub = node.subscribe<sensor_msgs::LaserScan>("base_scan", 1000, &Wallhugger3::laserCallback, this);
...
void Wallhugger3::laserCallback(const sensor_msgs::LaserScan::ConstPtr& scan){
...
bool Wallhugger3::CheckValidRange(float rng){
